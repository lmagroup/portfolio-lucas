export const skillCategories = [
  {
    ...
    icon: '🖥️',
    skills: [
      { name: 'React', level: 'Maîtrisé', color: '#61DAFB' },
      { name: 'JavaScript', level: 'Maîtrisé', color: '#F7DF1E' },
      { name: 'TypeScript', level: 'Confirmé', color: '#3178C6' },
      { name: 'HTML5', level: 'Maîtrisé', color: '#E34F26' },
      { name: 'CSS3', level: 'Maîtrisé', color: '#1572B6' },
      { name: 'TailwindCSS', level: 'Maîtrisé', color: '#06B6D4' },
      { name: 'Framer Motion', level: 'Confirmé', color: '#0055FF' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Serverless', level: 'Confirmé', color: '#0EA5A4' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'ESLint / Prettier', level: 'Maîtrisé', color: '#4B32C3' },
      { name: 'Vitest', level: 'Confirmé', color: '#6E9F18' },
      { name: 'Figma', level: 'Confirmé', color: '#F24E1E' },
